...
def kopp14_postprocess_verticallandmotion(
    preprocess_dict,
    nsamps,
    rng_seed,
    baseyear,
    ...
    ncvar_attributes = {
        "description": "Local SLR contributions from vertical land motion according to Kopp 2014 workflow",
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run the post-processing stage for the Kopp 14 vertical land motion workflow",
